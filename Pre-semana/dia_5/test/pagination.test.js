...
describe("#Pagination tests", () => {
    ...
    describe("#Pagination", () => {
        ...
        it("#sleep should be a Promise object and not return values", async () => {
            ...
            const time = 1;
            const pendingPromise = Pagination.sleep()
            clock.tick(time);
        ...
        describe("#handleRequest", () => {
            ...
            it("Should retry an requets twice throing an exception and validate request params an flow", async () => {
            ...
            it("Should return data from requets succeded", async () => {
        ...
        describe("#getPaginated", () => {
            ...
            it('should update request id on each on request', async () => {
                const pagination = new Pagination();
                sandbox.stub(
                    Pagination,
                    Pagination.sleep.name
                ...
                sandbox.spy(pagination, pagination.getPagination.name);
                const data = { url: "htttps://google.com", page: 1 }
                ...
                const gen = pagination.getPagination(data)
            ...
            it('should stop requesting when request return an empty array', async () => {
                ...
                sandbox.spy(pagination, pagination.getPagination.name);
                const data = { url: "htttps://google.com", page: 1 }
                const iterator = await pagination.getPagination(data);
                ...
                assert.ok(Pagination.sleep.calledWithExactly(expectedThreshold), 1);
            })
        })
